                            ...
                            <form action="{{ url('/update/' . $transaction->id) }}" method="post">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            <select class="form-control select2" style="width: 100%;">
                                                ...
                                                <option value="{{ $transaction->driver }}">{{ $driver->first_name }}
                                ...
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type='text' value="{{ $transaction->amt_adv }}" name="amt_adv"
                                            id="amtadv" class="form-control" onchange="updateDue()" />
                                    </div>
                                ...
                                <div class="form-row mb-4">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type='text' id="rbknamt" class="form-control"
                                            value="{{ $transaction->rebooking_amt }}" name="rebooking_amt"
                                            onkeyup="updateDue()" onkeyup="updateDue1()" /></td>
                                    </div>

                                    <div class="form-group col-md-2">
                                        <label for="inputEmail4">2nd REBOOKING AMOUNT</label>
                                        <input type='text' id="rbknamt1" class="form-control"
                                            value="{{ $transaction->rebooking_amt2 }}" name="rebooking_amt2"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type='text' id="clsnbal" value="{{ $transaction->closing_bal }}"
                                        name="closing_bal" class="form-control" />
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">FINAL RECOVERY</label>
                                    <input type='text' id="rec" value="{{ $transaction->final_recovery }}"
                                        name="final_recovery" class="form-control" onkeyup="updateDue2()" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">TOTAL AMOUNT RECOVERD</label>
                                    <input type='text' class="form-control"
                                        value="{{ $transaction->total_amt_recoverd }}" name="total_amt_recoverd"
                                        id="amtrec" />
                                </div>

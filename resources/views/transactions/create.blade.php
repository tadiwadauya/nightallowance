...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="form-group col-md-6">
            ...
            <input type='text' id="rbknamt" class="form-control" name="rebooking_amt" onkeyup="updateDue()" onkeyup="updateDue2()" /></td>
            </div>
            </div>
        ...
        No <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck"><br>
            ...
            <div class="form-group col-md-6">
            <label for="inputEmail4">REBOOKING AMOUNT</label>
            <input type='text' id="rbknamt1" class="form-control" name="rebooking_amt2" onkeyup="updateDue()" onchange="updateDue2()" /></td>
            </div>

            </div>
            <div class="form-group col-md-6">
            <label for="inputEmail4">CLOSING BALANCE</label>
            <input type='text' id="clsnbal" name="closing_bal" class="form-control" onkeyup="updateDue2()" />
            </div>

            <div class="form-group col-md-6">
            <label for="inputEmail4">FINAL RECOVERY</label>
            <input type='text' id="rec" name="final_recovery" class="form-control" onkeyup="updateDue2()"   />
            </div>
            <div class="form-group col-md-6">

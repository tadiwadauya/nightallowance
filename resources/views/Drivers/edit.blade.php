        ...
        <div class="widget-content widget-content-area">
            <form action="{{ route('driver.update',$driver->id)}}"  method="post">
                ...
                @csrf
                      <div class="row mb-4">
                        <div class="col">
                            <input type="text" value="{{$driver->first_name}}" name="first_name" class="form-control" >
                        </div>
                        <div class="col">
                            <input type="text" value="{{$driver->last_name}}" name="last_name" class="form-control">
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col">
                            <input type="text" value="{{$driver->pay_number}}" name="pay_number" class="form-control" >
                        </div>

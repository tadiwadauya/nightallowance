        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">  <a href="{{ url('driver/create') }}">Create User</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="row">
           ...
           <form action="{{url('driver/store')}}"  method="post">
            @csrf
                ...
                <div class="row mb-4">
                    <div class="col">
                        <input type="text" name="pay_number"   class="form-control @error('pay_number') is-invalid @enderror" placeholder="Paynumber ">
                        @error('paynumber')
                        <span class="invalid-feedback" role="alert">
                            <strong> {{ $message }}</strong>
                        </span>
